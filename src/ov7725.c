...
static const uint8_t default_regs[][2] = {
    {COM3,          COM3_SWAP_YUV},  //COM3_MIRROR
    {COM7,          COM7_RES_QVGA | COM7_FMT_YUV},

    {COM4,          0x01 | 0x30}, /* bypass PLL (0x00:off, 0x40:4x, 0x80:6x, 0xC0:8x) */
    ...
    {COM8,          0xFc}, //FE AEC off, FC AEC/AWB off
    {AECH,          0x00},
    {AEC,           0x3f},
    ...
    0: Limit the minimum exposure time to 1 row
    1: Allow exposure time to be less than 1 row
    Bit[2]: AGC Enable
    0: Manual mode
    1: Auto mode
    Bit[1]: AWB Enable
    ...
    */
    ...
    {COM6,          0xC5},
    {COM9,          0x01}, //0x11, Bit[7]: Histogram or average based AEC/AGC selection
...
static int set_framesize(sensor_t *sensor, framesize_t framesize)
{
    ...
    if (framesize == FRAMESIZE_QQVGA) {
        ...
        ret |= SCCB_Write(sensor->slv_addr, SCAL0, 0x0a);
        ret |= SCCB_Write(sensor->slv_addr, SCAL1, 0x40);
        ret |= SCCB_Write(sensor->slv_addr, SCAL2, 0x40);
